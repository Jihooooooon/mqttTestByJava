...
public class Sample implements MqttCallback {
	...
	public static void main(String[] args) {
		...
		int qos 			= 2;
		String broker 		= "192.168.244.129";
		int port 			= 1883;
		String clientId 	= null;
		String subTopic		= "/topic/security";
		String pubTopic 	= "/topic/security";
    ...
    public void publish(String topicName, int qos, byte[] payload) throws MqttException {
    	...
    	log("Publishing at: "+time+ " to topic \""+topicName+"\" qos "+qos+" text:"+message.toString());
